  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <div className="relative">
        <motion.div
          className="relative w-10 h-10 bg-primary-gradient rounded-md transition-all duration-300 hover:shadow-[0_0_8px_rgba(196,39,224,0.7),0_0_12px_rgba(132,74,255,0.5),0_0_16px_rgba(18,169,255,0.3)]"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-12 left-0 z-50 min-w-[200px] bg-[#1A062A] rounded-md border border-purple-500/20 shadow-lg h-[400px] overflow-x-hidden overflow-y-scroll"
            style={{
              boxShadow:
